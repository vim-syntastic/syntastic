...
(function() {
  ...
  ASTLinter = (function() {
    ...
    ASTLinter.prototype.lintNode = function(node, indent) {
      var attrs, complexity, name, solo,
        _this = this;
      ...
      node.eachChild(function(childNode) {
        ...
        complexity += _this.lintNode(childNode, indent + '  ');
        return true;
      });
      console.log("" + indent + " " + node.constructor.name + " - " + solo + " " + complexity);
      if (name === 'Code' && complexity > 1) {
        attrs = {
          context: complexity,
          level: this.config['cyclomatic_complexity'].level,
          line: 0
        };
