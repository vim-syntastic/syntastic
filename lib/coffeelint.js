...
(function() {
  ...
  LexicalLinter = (function() {
    ...
    LexicalLinter.prototype.lintToken = function(token) {
      ...
      switch (type) {
        case "->":
          return this.lintArrowSpacing(token, this.tokens[this.i - 1]);
        case "INDENT":
    ...
    LexicalLinter.prototype.lintArrowSpacing = function(token, prevTok) {
      if (!(((token.spaced != null) || (token.newLine != null)) && ((prevTok.spaced != null) || (prevTok.generated != null) || (prevTok.isInterpolation != null) || prevTok[0] === "INDENT" || (prevTok[0] === "CALL_START" && !(prevTok.generated != null))))) {
