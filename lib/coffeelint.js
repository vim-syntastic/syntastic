(function() {
  ...
  */
  ...
  LineLinter = (function() {
    ...
    function LineLinter(source, config) {
      this.source = source;
      this.config = config;
      this.line = null;
      this.lineNumber = 0;
    ...
    LineLinter.prototype.lintLine = function() {
      var error;
      error = this.checkTabs() || this.checkTrailingWhitespace() || this.checkLineLength();
      return error;
    };
  ...
  coffeelint.lint = function(source, userConfig) {
    var config, lexErrors, lexicalLinter, lineErrors, lineLinter;
