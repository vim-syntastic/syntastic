...
(function() {
  ...
  ASTLinter = (function() {
    ...
    ASTLinter.prototype.lintNode = function(node) {
      var attrs, complexity, name, rule, _ref,
        _this = this;
      name = node.constructor.name;
      complexity = name === 'If' || name === 'While' || name === 'For' || name === 'Try' ? 1 : name === 'Switch' ? node.cases.length : name === 'Op' && ((_ref = node.operator) === '&&' || _ref === '||') ? 1 : 0;
      ...
      if (node.constructor.name === 'Code' && complexity >= rule.value) {
        attrs = {
          context: complexity + 1,
          level: rule.level,
          line: 0
        };
        this.errors.push(createError('cyclomatic_complexity', attrs));
      }
      return complexity;
    };
