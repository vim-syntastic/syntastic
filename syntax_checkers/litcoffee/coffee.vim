...
"
if exists("g:loaded_syntastic_litcoffee_coffee_checker")
    finish
endif
let g:loaded_syntastic_litcoffee_coffee_checker=1

function! SyntaxCheckers_litcoffee_coffee_IsAvailable()
...
function! SyntaxCheckers_litcoffee_coffee_GetLocList()
